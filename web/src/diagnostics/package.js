...
export function createDiagnosticPackage({ preflight, browser, connection, device, receiver, stream, processing, audio, capture, application, project, logs, includeSerial = false }) {
