...
export class CaptureStore {
  ...
  async start(metadata) {
    ...
    const record = {
      ...
      sstvInputMode: ["auto", "usb", "fm"].includes(metadata.sstvInputMode) ? metadata.sstvInputMode : null,
      sstvMode: typeof metadata.sstvMode === "string" ? metadata.sstvMode : null,
      sstvAutoVis: typeof metadata.sstvAutoVis === "boolean" ? metadata.sstvAutoVis : null,
      sstvPhaseOffset: Number.isFinite(Number(metadata.sstvPhaseOffset)) ? Number(metadata.sstvPhaseOffset) : null,
      sstvSlant: Number.isFinite(Number(metadata.sstvSlant)) ? Number(metadata.sstvSlant) : null,
