...
export function runPreflight(scope = globalThis) {
  ...
  const results = [
    ...
    row("audio-worklet", "AudioWorklet", audioWorklet ? "pass" : "warn", audioWorklet ? "Available" : "Unavailable", "Audio receivers are not enabled in version 0.2.0; use a browser with AudioWorklet before that batch is activated."),
