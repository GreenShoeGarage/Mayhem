...
export function runPreflight(scope = globalThis) {
  ...
  const results = [
    ...
    row("audio-worklet", "AudioWorklet", audioWorklet ? "pass" : "warn", audioWorklet ? "Available" : "Unavailable", "Audio receivers are not enabled in version 0.1.0; use a browser with AudioWorklet before that batch is activated."),
