...
export const APPLICATIONS = Object.freeze([
  { id: "spectrum", name: "Spectrum Analyzer", icon: "∿", category: "Receive", requiresReceive: true, requiresTransmit: false, minimumFrequencyHz: 0, maximumFrequencyHz: 0, preferredSampleRate: 1024000, minimumSampleRate: 225001, requiredBandwidthHz: 0, requiresAudio: false, requiresMap: false, portState: PortState.READY, verificationState: VerificationState.SIMULATION_TESTED, limitations: ["Live radio path is hardware-unverified in v0.1.0."] },
